  ...
  return (
    <div className="p-6 bg-[#1C2126] rounded-lg shadow-md text-[#F5F2F4] font-mono max-w-4xl mx-auto mt-4">
      ...
      <section className="mb-8">
        ...
        <p className="text-base leading-relaxed">
          เกมนี้ได้รับแรงบันดาลใจจากเกมทอยลูกเต๋าคลาสสิกอย่าง "Pig" และถูกพัฒนาขึ้นเพื่อมอบประสบการณ์ที่สนุกและท้าทายทั้งในโหมดผู้เล่นสองคนและโหมด AI
        </p>
        <ul className="list-disc list-inside mt-2 space-y-2">
          <li><strong>เวอร์ชัน 1.0:</strong> เปิดตัวระบบพื้นฐาน (ทอยลูกเต๋า, เก็บคะแนน, เปลี่ยนผู้เล่น) และ UI ที่ใช้งานง่าย</li>
          <li><strong>เวอร์ชัน 1.1:</strong> เพิ่มโหมด AI (ง่าย, ปานกลาง, ยาก) และระบบตั้งค่าเป้าหมายคะแนน</li>
          <li><strong>เวอร์ชัน 1.2:</strong> เพิ่มแอนิเมชันลูกเต๋า, เสียงเอฟเฟกต์, และโหมดทัวร์นาเมนต์</li>
          <li><strong>เวอร์ชัน 1.3:</strong> เพิ่มระบบบันทึกประวัติและสถิติ พร้อมฟีเจอร์ส่งออก/นำเข้าข้อมูล</li>
          <li><strong>เวอร์ชันล่าสุด:</strong> เพิ่มการปรับแต่งธีม, โหมดความเร็ว, และระบบรางวัล/ความสำเร็จ</li>
        </ul>
      </section>
